# Generated by Django 4.0 on 2023-06-21 02:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='participants', to='core.user', verbose_name='Пользователь')),
            ],
            options={
