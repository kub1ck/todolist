# Generated by Django 4.0 on 2023-06-16 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.user', verbose_name='Автор')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goal',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.user', verbose_name='Автор'),
        ),
    ]
